const listWordData= [
    ...
    { id:76 , word:'午前' , hira: 'ごご' ,mean:'Sau 12 giờ trưa, chiều' , miss:false , level:1 },
    { id:77 , word:'朝' , hira: 'あさ' ,mean:'Buổi sáng' , miss:false , level:1 },
    { id:78 , word:'昼' , hira: 'ひる' ,mean:'Buổi trưa' , miss:false , level:1 },
    ...
    { id:86 , word:'毎日' , hira: 'まいにち' ,mean:'Mỗi ngày' , miss:false , level:0 },
    { id:87 , word:'月曜日' , hira: 'げつようび' ,mean:'Thứ hai' , miss:false , level:0 },
    { id:88 , word:'火曜日' , hira: 'かようび' ,mean:'Thứ ba' , miss:false , level:1 },
    { id:89 , word:'水曜日' , hira: 'すいようび' ,mean:'Thứ tư' , miss:false , level:1 },
    ...
    { id:93 , word:'日曜日' , hira: 'にちようび' ,mean:'Chủ Nhật' , miss:false , level:1 },
    { id:94 , word:'番号' , hira: 'ばんごう' ,mean:'Số (điện thoại, phòng)' , miss:false , level:1 },
    { id:95 , word:'行く' , hira: 'いく' ,mean:'Đi' , miss:false , level:0 },
    { id:96 , word:'帰る' , hira: '帰る' ,mean:'Về' , miss:false , level:1 },
    { id:97 , word:'来る' , hira: 'くる' ,mean:'Đến' , miss:false , level:2 },
    { id:98 , word:'学校' , hira: 'がっこう' ,mean:'Trường học' , miss:false , level:1 },
    ...
    { id:102 , word:'電車' , hira: 'でんしゃ' ,mean:'Tàu điện' , miss:false , level:1 },
    { id:103 , word:'地下鉄' , hira: 'ちかてつ' ,mean:'Tàu điện ngầm' , miss:false , level:2 },
    { id:104 , word:'新幹線' , hira: 'しんかんせん' ,mean:'Tàu shinkansen' , miss:false , level:6 },
    { id:105 , word:'歩いて' , hira: 'あるいて' ,mean:'Đi bộ' , miss:false , level:2 },
    { id:106 , word:'人' , hira: 'ひと' ,mean:'Người' , miss:false , level:1 },
    ...
    { id:111 , word:'先週' , hira: 'せんしゅう' ,mean:'Tuần trước' , miss:false , level:1 },
    { id:112 , word:'今週' , hira: 'こんしゅう' ,mean:'Tuần này' , miss:false , level:1 },
    ...
    { id:126 , word:'建国記念の日' , hira: 'けんこくきねんのひ' ,mean:'Ngày Quốc khánh' , miss:false , level:6 },
    { id:127 , word:'春分' , hira: 'しゅんぶん' ,mean:'Xuân phân' , miss:false , level:6 },
    { id:128 , word:'秋分' , hira: 'しゅうぶん' ,mean:'Thu phân' , miss:false , level:6 },
    { id:129 , word:'食べる' , hira: 'たべる' ,mean:'Ăn' , miss:false , level:0 },
    { id:130 , word:'飲む' , hira: 'のむ' ,mean:'Uống' , miss:false , level:0 },
    { id:131 , word:'見る' , hira: 'みる' ,mean:'Nhìn, xem, trông' , miss:false , level:0 },
    { id:132 , word:'聞く' , hira: 'きく' ,mean:'Nghe' , miss:false , level:1 },
    { id:133 , word:'読む' , hira: 'よむ' ,mean:'Đọc' , miss:false , level:1 },
    { id:134 , word:'書く' , hira: 'かく' ,mean:'Viết, vẽ' , miss:false , level:1 },
    { id:135 , word:'買う' , hira: 'かう' ,mean:'Mua' , miss:false , level:1 },
    { id:136 , word:'会う' , hira: 'あう' ,mean:'Gặp' , miss:false , level:1 },
    { id:137 , word:'卵' , hira: 'たまご' ,mean:'Trứng' , miss:false , level:3 },
    { id:138 , word:'肉' , hira: 'にく' ,mean:'Thịt' , miss:false , level:2 },
    { id:139 , word:'魚' , hira: 'さかな' ,mean:'Cá' , miss:false , level:2 },
